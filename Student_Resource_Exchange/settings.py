...
INSTALLED_APPS = [
    ...
    'theme',  # Theme templates and static files
    'landing',
    'registration',
    'login',
    'dashboard',
...
# Add django-tailwind only in development (requires Node.js)
if DEBUG:
    INSTALLED_APPS.insert(INSTALLED_APPS.index('theme'), 'tailwind')
